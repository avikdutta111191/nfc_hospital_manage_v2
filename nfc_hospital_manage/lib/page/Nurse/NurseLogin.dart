...
import 'package:nfc_hospital_manage/page/Nurse/N_homePage.dart';
...
class NurseLogin extends StatelessWidget {
  ...
  Future<void> addNurse(LoginData data) {
    CollectionReference users = FirebaseFirestore.instance.collection('nurse');
    ...
    return FlutterLogin(
      ...
      onSubmitAnimationCompleted: () {
        Navigator.of(context).pushReplacement(MaterialPageRoute(
          builder: (context) => N_HomePage(title: 'Nurse Desk',user_: user_),
        ));
      },
