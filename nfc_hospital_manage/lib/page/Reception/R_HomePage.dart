...
class R_HomePage extends StatefulWidget {
  R_HomePage({Key? key, required this.title,required this.user_}) : super(key: key);
  ...
  @override
  _R_HomePageState createState() => _R_HomePageState();



}

class _R_HomePageState extends State<R_HomePage>{
             ...
             onTap: (){
               Navigator.push(
                 ...
                 MaterialPageRoute<void>(
                   builder: (BuildContext context) => ProfileEdit(title: 'recep', user_: widget.user_),
