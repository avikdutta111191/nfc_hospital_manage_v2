...
class ReceptionLogin extends StatelessWidget {
  ...
  Future<void> addReceptionist(LoginData data) {
    CollectionReference users = FirebaseFirestore.instance.collection('receptionist');
...
/*    catch (e) {
      ...
      } else if (e.toString() == 'ERROR_WRONG_PASSWORD') {
  ...
  Widget build(BuildContext context) {
    return FlutterLogin(
      ...
      onSubmitAnimationCompleted: () {
          ...
          builder: (context) => R_HomePage(title: 'Reception Desk',user_: user_),
        ));
      },
